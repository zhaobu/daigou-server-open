...
) ENGINE = InnoDB AUTO_INCREMENT = 1000028 AVG_ROW_LENGTH = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '用户表' ROW_FORMAT = Dynamic;
