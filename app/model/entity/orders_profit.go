...
// OrdersProfit struct is a row record of the orders_profit table in the daigou database
...
func (o *OrdersProfit) TableName() string {
	return "orders_profit"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (o *OrdersProfit) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (o *OrdersProfit) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (o *OrdersProfit) Validate(action Action) error {
	return nil
}
