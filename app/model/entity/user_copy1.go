...
// UserCopy1 struct is a row record of the user_copy1 table in the daigou database
type UserCopy1 struct {
...
func (u *UserCopy1) TableName() string {
	return "user_copy1"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (u *UserCopy1) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (u *UserCopy1) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (u *UserCopy1) Validate(action Action) error {
	return nil
}
